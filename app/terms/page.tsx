      ...
      <div className="px-6 md:px-12 pb-24 max-w-[800px] mx-auto">
        <div className="prose-custom space-y-10">
          ...
          <section>
            ...
            <p>Subscriptions are offered on a monthly ($9.99/month) or annual ($79.99/year) basis and are processed through Apple's in-app purchase system. By subscribing, you agree to Apple's payment terms.</p>
