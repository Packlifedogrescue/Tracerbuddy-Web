        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <Reveal className="relative z-10">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6">
              <a
                ...
                className="inline-flex items-center gap-2.5 bg-[#1A1A1A] px-4 py-2.5 rounded-xl hover:bg-black transition-all hover:-translate-y-0.5"
              >
                <svg width="18" height="22" viewBox="0 0 18 22" fill="#F5EFE0">
                ...
                <div>
                  <div className="text-[9px] leading-none text-[#F5EFE0]/70 mb-0.5">Download on the</div>
                  <div className="text-[14px] font-semibold leading-none text-[#F5EFE0]">App Store</div>
                </div>
              </a>
            </div>
          ...
          <Reveal delay={200} className="relative flex items-center justify-center">
            ...
            <Image
              ...
              className="relative max-h-[680px] max-w-full w-auto object-contain drop-shadow-[0_40px_80px_rgba(26,26,26,0.2)] mix-blend-multiply"
              priority
            />
          </Reveal>
        </div>
