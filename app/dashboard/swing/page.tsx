...
export default function SwingPage() {
  ...
  return (
    <div className="p-8 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-black text-[#111]">Swing Data</h1>
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        ...
        <div className="card p-6 text-center">
          ...
          <div className="text-4xl font-black text-[#111]">{avgDriver}</div>
          <div className="text-xs text-gray-500">mph</div>
        </div>
      </div>
              ...
              {clubAvgs.map(({ club, avg, count }) => (
                <div key={club} className="flex items-center gap-4">
                  ...
                  <div className="text-right">
                    <span className="text-[#111] font-black">{avg.toFixed(1)}</span>
